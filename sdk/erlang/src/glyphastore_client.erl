...
read_op(health, _) -> {glyphastore_protocol:opcode_health(), <<"health">>, <<>>};
read_op(ready, _) -> {glyphastore_protocol:opcode_ready(), <<"ready">>, <<>>};
read_op(stats, _) -> {glyphastore_protocol:opcode_stats(), <<"stats">>, <<>>};
