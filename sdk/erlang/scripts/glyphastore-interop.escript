...
dispatch(Client, "worker-pipelines-put-get", Key, Value, _Expire, _Config, _Burst) ->
    WorkerCount = glyphastore_client:worker_count(Client),
    ...
    case glyphastore_client:execute_worker_pipelines(Client, Wave) of
...
discover_owned_keys(Client, Prefix, WorkerCount, Candidate, Acc) ->
    ...
    {ok, Owner} = glyphastore_client:worker_for(Client, Probe),
