# Verifying a GlifiStore release
...
gh attestation verify verified-seal.json \
  --repo gpicchiarelli/GlifiStore \
  --bundle verified-seal.sigstore.json \
  --signer-workflow https://github.com/gpicchiarelli/GlifiStore/.github/workflows/release.yml
```
...
Each SPDX document must describe exactly one GlifiStore root package whose SHA-256 matches the
