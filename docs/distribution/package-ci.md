...
## Sealed N−1 upgrade continuity

`package-upgrade` is selected from the release context (SemVer precedence over annotated tags),
never as “current version minus one”:
